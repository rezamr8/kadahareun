package com.e74Studio.kumpulan.anekaresepkue;
...
import com.e74Studio.kumpulan.anekaresepkue.util.NetworkHandler;
import com.e74Studio.kumpulan.anekaresepkue.util.PermissionUtil;
import com.e74Studio.kumpulan.anekaresepkue.util.ProgressDialogHelper;
import com.e74Studio.kumpulan.anekaresepkue.util.UrlHander;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, DownloadListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StartAppSDK.init(this, "202169599", true);
    ...
    class UriChromeClient extends WebChromeClient {
        ...
        public boolean onCreateWindow(WebView view, boolean isDialog,
            ...
            //tambahan
            mWebviewPop.getSettings().setAllowUniversalAccessFromFileURLs(true);
